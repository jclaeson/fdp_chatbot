...
export default function Chat() {
  ...
  // Check if running in embed mode (iframe/extension)
        ...
        <div className="p-4 border-t border-white/5">
          <div className="relative">
            ...
            <Button 
              onClick={handleSend}
              size="icon" 
              className="absolute right-2 top-1.5 md:top-2 h-9 w-9 md:h-10 md:w-10 bg-primary hover:bg-primary/90 text-white"
            >
